...
<div class='page-content'>
	<div class='row'>		
		<div class="col-xs-12">
			...
			<form class="form-horizontal" id='form' method="post" enctype="multipart/form-data" action="<?php echo base_url($this->router->fetch_class().'/simpan'); ?>" role="form">										
				<input type='hidden' name='key' value='<?php echo $info_id; ?>'>
				<div class="widget-box transparent">
					<div class="widget-header widget-header-flat widget-header-small">
						<h4 class="widget-title smaller">
							<i class="ace-icon fa fa-exclamation orange"></i>
								<?php echo $sub;?>
						</h4>
							<div class='pull-right'>	
								...
								<?php echo ($this->_priv->INFR || $this->_priv->INFU) ? "<button type='submit' name='submit' value='".$val."' class='btn btn-primary btn-round btn-white  btn-sm fa fa-save' data-rel='tooltip' data-placement='bottom' title='".$val."'></button>" : ''; ?>
							</div>
					</div>	
								...
								<div class='col-xs-12 col-sm-10'>	
									...
									<div class='col-xs-12 col-sm-12'>						
										<div class="form-group">
											<label class="col-sm-2 control-label" for="form-field-1"  style='margin-right:8px; text-align:left;'> Judul</label>
											<div class="col-sm-9">						
									...
									<div class='col-xs-12 col-sm-12'>						
										<div class="form-group">
											<label class="col-sm-2 control-label" for="form-field-1"  style='margin-right:8px; text-align:left;'> Batas Tampil</label>
									...
									<div class='col-xs-12 col-sm-12'>						
										<div class="form-group">
											<label class="col-sm-2 control-label" for="form-field-1"  style='margin-right:8px; text-align:left;'> Publis</label>
											<div class="col-sm-3">												
												<?php
									...
									<div class='col-xs-12 col-sm-12'>						
										<div class="form-group">
											<label class="col-sm-2 control-label" for="form-field-1"  style='margin-right:8px; text-align:left;'> Status</label>
											<div class="col-sm-3">						
												<?php
												$act = array('active'=>'Aktif','suspend'=>'Tidak Aktif');
