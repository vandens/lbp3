							...
							<div class="col-xs-12 col-sm-12">
								<div class="profile-user-info profile-user-info-striped">
									<div class="profile-info-row">
										<div class="profile-info-name" style='width:175px'> Kode / Nama Puskesmas</div>
											<div class="profile-info-value ">
												<span class="editable"><?php echo $pus_code.' - '.$pus_name;?></span>
											</div>				
									...
									<div class="profile-info-row">
										<div class="profile-info-name"> Nama Pengguna</div>
											<div class="profile-info-value ">
												<span class="editable"><?php echo $user_fullname;?></span>
											</div>	
									</div>
									...
									<div class="profile-info-row">
										<div class="profile-info-name"> Terakhir Login / Logout</div>
											<div class="profile-info-value ">
												<span class="editable"><?php echo (!empty($user_lastin) && !empty(user_lastout)) ? date('d M Y H:i:s',strtotime($user_lastin)).' / '.date('d M Y H:i:s',strtotime($user_lastout)) : '';?></span>
											</div>	
									</div>			
									<div class="profile-info-row">
